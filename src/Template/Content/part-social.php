<div class1="<?=(lang=='fa')?'pr-1':'pl-1'?> row" style1="<?=(lang=='fa')?'float:left;':'float:right;'?>">
    ...
    <div class="pl-2">
        <a href="<?=$metalist['sc_personal']?>" title="<?=$metalist['sc_personal']?>" target="_blank"
            class="social-icon si-dark si-pinboard si-small" title="<?=$metalist['sc_personal']?>" data-toggle="tooltip" data-placement="top" >
    ...
    <div class="pl-2">
        <a href="<?=$metalist['sc_instagram']?>" title="<?=$metalist['sc_instagram']?>" target="_blank"
            class="social-icon si-dark si-instagram si-small" data-toggle="tooltip" data-placement="top" title="<?=$metalist['sc_instagram']?>">
    ...
    <div class="pl-2">
        <a href="<?=$metalist['sc_twitter']?>" title="<?=$metalist['sc_twitter']?>" target="_blank"
            class="social-icon si-dark si-twitter si-small" data-toggle="tooltip" data-placement="top" title="<?=$metalist['sc_twitter']?>">
    ...
    <div class="pl-2">
        <a href="<?=$metalist['sc_facebook']?>" title="<?=$metalist['sc_facebook']?>"  target="_blank" 
            class="social-icon si-dark si-facebook si-small" data-toggle="tooltip" data-placement="top" title="<?=$metalist['sc_facebook']?>">
    ...
    <div class="pl-2">
        <a href="<?= $metalist['sc_telegram']?>" title="<?= $metalist['sc_telegram']?>" target="_blank" 
            class="social-icon si-dark si-twitter si-small" data-toggle="tooltip" data-placement="top" title="<?= $metalist['sc_telegram']?>">
    ...
    <div class="pl-2">
        <a href="<?= $metalist['sc_linkedin']?>" title="<?= $metalist['sc_linkedin']?>" target="_blank" 
            class="social-icon si-dark si-linkedin si-small" data-toggle="tooltip" data-placement="top" title="<?= $metalist['sc_linkedin']?>">
    ...
    <div class="pl-2">
        <a href="<?= $metalist['sc_youtube']?>" title="<?= $metalist['sc_youtube']?>" target="_blank" 
            class="social-icon si-dark si-youtube si-small" data-toggle="tooltip" data-placement="top" title="<?= $metalist['sc_youtube']?>">
    ...
    <div class="pl-2">
        <a href="<?= $metalist['sc_aparat']?>" title="<?= $metalist['sc_aparat']?>" target="_blank" 
            class="social-icon si-dark si-youtube si-small" data-toggle="tooltip" data-placement="top" title="<?= $metalist['sc_aparat']?>">
    ...
    <div class="pl-2">
        <a href="<?= $metalist['sc_bale']?>" title="<?= $metalist['sc_bale']?>" target="_blank" 
            class="social-icon si-dark si-youtube si-small" data-toggle="tooltip" data-placement="top" title="<?= $metalist['sc_bale']?>">
    ...
    <div class="pl-2">
        <a href="<?= $metalist['sc_rg']?>" title="<?= $metalist['sc_rg']?>" target="_blank" 
            class="social-icon si-dark si-youtube si-small" data-toggle="tooltip" data-placement="top" title="<?= $metalist['sc_rg']?>">
    ...
    <div class="pl-2">
        <a href="<?= $metalist['sc_orc']?>" title="<?= $metalist['sc_orc']?>" target="_blank" 
            class="social-icon si-dark si-youtube si-small" data-toggle="tooltip" data-placement="top" title="<?= $metalist['sc_orc']?>">
    ...
    <div class="pl-2">
        <a href="<?= $metalist['sc_gosc']?>" title="<?= $metalist['sc_gosc']?>" target="_blank" 
            class="social-icon si-dark si-youtube si-small" data-toggle="tooltip" data-placement="top" title="<?= $metalist['sc_gosc']?>">
    ...
    <div class="pl-2">
        <a href="<?= $metalist['sc_wos']?>" title="<?= $metalist['sc_wos']?>" target="_blank" 
            class="social-icon si-dark si-youtube si-small" data-toggle="tooltip" data-placement="top" title="<?= $metalist['sc_wos']?>">
    ...
    <div class="pl-2">
        <a href="<?= $metalist['sc_scop']?>" title="<?= $metalist['sc_scop']?>" target="_blank" 
            class="social-icon si-dark si-youtube si-small" data-toggle="tooltip" data-placement="top" title="<?= $metalist['sc_scop']?>">
    ...
    <?php if(isset($metalist['sc_email']) and $metalist['sc_email'] != ''):
        ...
        <a href="mailto:<?= $email?>" title="<?= $email?>" target="_blank" 
            class="social-icon si-dark si-linkedin si-small" data-toggle="tooltip" data-placement="top" title="<?= $email?>">
