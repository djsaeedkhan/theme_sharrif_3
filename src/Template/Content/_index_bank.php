...
<div id="page-menu" data-mobile-sticky="true">
	<div id="page-menu-wrap"class="page-menu-wrap1">
		...
		============================================= -->
<section id="content">
	<div class="content-wrap pt-01 pb-0" style="background: #40407e;">
		<div class="container-fluid bottommargin-lg1 clearfix">
			<div class="row">
				
				<div class="col-lg-12 pt-4 pb-5 bg-white" style1="background:<?=setting['color_bgall']?>;border-<?=((lang=='fa')?'left':'right')?>: 3px solid #d4616a;">
					<div class="container">
						...
						<article class="portfolio-item col-sm-3 col-12">
							<div class="grid-inner bg-white br-15" >
								...
								<div class="portfolio-desc pt-1" style="padding-left:15px;padding-right:15px;">
									...
									<h4 class="mb-1 pb-1 pt-2 text-center cls3">
										<a href="<?= $this->Query->the_permalink();?>">
									...
									<span>
										<a href="<?= $this->Query->the_permalink();?>" title="<?=setting['t_tozihat']?>" 
											class="btn btn-secondary float-right bg-color1 cls4">
